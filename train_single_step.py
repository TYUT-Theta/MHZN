...
parser.add_argument('--save', type=str, default='./model-exchange_rate.txt-3.pt',
...
def main():
    ...
    model = TDG4MSF(args.gcn_true, args.buildA_true, args.num_nodes,
                  device, dropout=args.dropout, subgraph_size=args.subgraph_size,
                  node_dim=args.node_dim,residual_channels=args.residual_channels,
                  seq_length=args.seq_in_len,layers=args.layers, tanhalpha=args.tanhalpha, layer_norm_affline=False)
